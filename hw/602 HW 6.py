...
def exercise01():
    ...
    df1=pd.DataFrame([['Lee',2],['Mike',4],['Ben',6],['Anna',8],['Ruth',10]], columns=['Name','Age'])
...
def exercise04():
    ...
    df4=pd.DataFrame([
        ...
        {'city':'Boston','data': 200},
        {'city':'Jersey City','data':300}
    ])
    # ------ Place code above here /\ /\ /\ ------
    return df4
...
def exercise06():
    ...
    # rename the columns of 'data.xlsx' since the original columns are 'id','name','value' to pass the testcase
    df6.columns=['A','B','C']
    # ------ Place code above here /\ /\ /\ ------
    return df6
